...
, COALESCE(SUM(TXN.MKDN_AMT),0) AS MKDN_AMT
, COALESCE(SUM(TXN.MKDN_AMT + TXN.MKDN_WOD_ALLOC_AMT + TXN.MKDN_POD_ALLOC_AMT),0) AS COMBINED_MKDN
...
, SUM(COMBINED_MKDN) AS COMBINED_MKDN
FROM T2
GROUP BY 1,2          
""")
